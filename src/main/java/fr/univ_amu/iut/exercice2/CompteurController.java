...
public class CompteurController {
  ...
  private void initialize() {
    // exercice 2 : lier le texte du label à la valeur du compteur.
    //
  ...
  private void incrementer() {
    // exercice 2 : incrémenter la valeur de la propriété compteur.
  ...
  private void decrementer() {
    // exercice 2 : décrémenter la valeur de la propriété compteur.
    compteur.set(compteur.get() - 1);
  }
  ...
  private void reinitialiser() {
    // exercice 2 : remettre la propriété compteur à 0.
    compteur.set(0);
  }
